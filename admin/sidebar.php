<aside class="sidebar" id="sidebar">
            <div class="sidebar-header" id="companylogo">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="admin.php" class="nav-link <?php if(isset($admin)) echo'active';?>" data-section="home">
                    ...
                    <li class="nav-item">
                        <a href="employee.php" class="nav-link <?php if(isset($employees)) echo'active';?>" data-section="employees">
                            <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <li class="nav-item">
                        <a href="onboarding.php" class="nav-link <?php if(isset($onboarding)) echo'active';?>" data-section="onboarding">
                            <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
